...
public final class RecipeVisitor extends DirectivesBaseVisitor<RecipeSymbol.Builder> {
  ...
  /**
   * A Directive can include byte size specifications (e.g., "10KB", "1GB").
   * This visitor method extracts the byte size value and creates a token type
   * {@code ByteSize} to be added to the {@code TokenGroup}.
   */
  @Override
  ...
  /**
   * A Directive can include time duration specifications (e.g., "150ms", "2h").
   * This visitor method extracts the time duration value and creates a token type
   * {@code TimeDuration} to be added to the {@code TokenGroup}.
   */
  @Override
